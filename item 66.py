...
welcome.config(font=("Comic Sans MS", 20))
...
def createDB():
    with sqlite3.connect("file_transfer_database.db") as connection:
        ...
        # Create Table
        c.executescript("""
            CREATE TABLE IF EXISTS Transfers;
        ...
        with sqlite3.connect("file_transfer_database.db") as connection:
            ...
            for root,directories,filenames in os.walk(source):
                for file in filenames:
                    ...
                    if fnmatch.fnmatch(file, '*.txt'): #if you change txt to different type then this will be a different file transfer system
